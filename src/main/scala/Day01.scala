...
object Day01 extends App{
  ...
  println(s"Day 01 Part One:  fuel required is $sum")
  ...
  println(s"Day 01 Part Two $sumTotal")
  println(s"Day 01 Part Two:  fuel required + fuel for the fuel ${sum + sumTotal}")
